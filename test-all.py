...
parser = argparse.ArgumentParser(description='Test AP3D using all frames')  ## 是来使用全部的帧的图像来进行测试的过程的。
# Datasets
parser.add_argument('--root', type=str, default='D:/datasets')  ## 这里是来对应的数据根路径的。
...
# Miscs
parser.add_argument('--resume', type=str, default='C:/Users/Administrator/Desktop/代码/5-7/AP3D-master/log-mars-ap3d', metavar='PATH')
parser.add_argument('--test_epochs', default=[240], nargs='+', type=int) ## 最开始时候还是240
